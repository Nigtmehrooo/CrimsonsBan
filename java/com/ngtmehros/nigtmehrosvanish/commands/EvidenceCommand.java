...
import com.ngtmehros.nigtmehrosvanish.DiscordWebhookService;
import com.ngtmehros.nigtmehrosvanish.EvidenceCollection;
import com.ngtmehros.nigtmehrosvanish.BannReplaySystem;
import com.ngtmehros.nigtmehrosvanish.MultiAccountDetection;
...
public class EvidenceCommand implements CommandExecutor {
    ...
    private void startReplayRecording(CommandSender sender, UUID targetUuid, String targetName) {
        ...
        // Discord Embed für Replay-Start
    ...
    private void showLinkedAccounts(CommandSender sender, UUID targetUuid, String targetName) {
        ...
        // Discord Embed für Multi-Account Info
    ...
    private void captureInventoryEvidence(CommandSender sender, UUID targetUuid, String targetName) {
        ...
        // Inventory-Informationen sammeln
